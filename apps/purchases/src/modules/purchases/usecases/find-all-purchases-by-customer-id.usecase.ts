...
@Injectable()
export class FindAllPurchasesByCustomerIdUseCase
  implements UseCase<CustomerId, PurchaseEntity[]>
{
  constructor(
  ...
  public async execute(customerId: CustomerId): Promise<PurchaseEntity[]> {
